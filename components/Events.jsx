      ...
      <div className="relative top-12">
        ...
        <EventCard title="COMING SOON" image="/events/image (35).jpg" register="https://forms.gle/vH5Ertv1rzLA9nrT8"/>
          ...
          <div className="events-gallery">
            ...
            <div className="column">
              <div className="event-card">
                <img className="event-poster" src="/events/image (19).jpg" />
                <div className="event-description">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Neque dolor dolores quaerat nobis optio ea alias error eum
                  unde fugiat.
              ...
              <div className="event-card">
                <img className="event-poster" src="/events/image (14).jpg" />
                <div className="event-description">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Neque dolor dolores quaerat nobis optio ea alias error eum
                  unde fugiat.
              ...
              <div className="event-card">
                <img className="event-poster" src="/events/image (15).jpg" />
                <div className="event-description">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Neque dolor dolores quaerat nobis optio ea alias error eum
                  unde fugiat.
            ...
            <div className="column">
              <div className="event-card">
                <img className="event-poster" src="/events/image (16).jpg" />
                <div className="event-description">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Neque dolor dolores quaerat nobis optio ea alias error eum
                  unde fugiat.
              ...
              <div className="event-card">
                <img className="event-poster" src="/events/image (17).jpg" />
                <div className="event-description">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Neque dolor dolores quaerat nobis optio ea alias error eum
                  unde fugiat.
              ...
              <div className="event-card">
                <img className="event-poster" src="/events/image (18).jpg" />
                <div className="event-description">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Neque dolor dolores quaerat nobis optio ea alias error eum
                  unde fugiat.
            ...
            <div className="column">
              <div className="event-card">
                <img className="event-poster" src="/events/image (13).jpg" />
                <div className="event-description">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Neque dolor dolores quaerat nobis optio ea alias error eum
                  unde fugiat.
              ...
              <div className="event-card">
                <img className="event-poster" src="/events/image (20).jpg" />
                <div className="event-description">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Neque dolor dolores quaerat nobis optio ea alias error eum
                  unde fugiat.
              ...
              <div className="event-card">
                <img className="event-poster" src="/events/image (21).jpg" />
                <div className="event-description">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Neque dolor dolores quaerat nobis optio ea alias error eum
                  unde fugiat.
            ...
            <div className="column">
              <div className="event-card">
                <img className="event-poster" src="/events/image (22).jpg" />
                <div className="event-description">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Neque dolor dolores quaerat nobis optio ea alias error eum
                  unde fugiat.
              ...
              <div className="event-card">
                <img className="event-poster" src="/events/image (23).jpg" />
                <div className="event-description">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Neque dolor dolores quaerat nobis optio ea alias error eum
                  unde fugiat.
              ...
              <div className="event-card">
                <img className="event-poster" src="/events/image (24).jpg" />
                <div className="event-description">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Neque dolor dolores quaerat nobis optio ea alias error eum
                  unde fugiat.
